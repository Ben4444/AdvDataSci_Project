...
Fill in user coordinates
Export to final dataset
Check missing (is.na) in coordinates and city and state to a dataset and do table on dataset
Fill in city and state
Manually fill in the cities set to ""
Set unneeded variables equal to NULL
Save dataset
Commit
