...
packages<-c("tibble","dplyr", "tidyr", "stringr", "jsonlite", "rdrop2", "data.table", "ggplot2", "maps", "ggmap", "gridExtra", "grid", "spatstat", "splancs", "maptools", "rgeos", "repmis")
...
tweets_tbl <- source_data("https://github.com/Ben4444/AdvDataSci_Project/blob/master/tweets_tbl.rds?raw=true")
tweets_flat <- source_data("https://github.com/Ben4444/AdvDataSci_Project/blob/master/tweets_flat.rds?raw=true")
