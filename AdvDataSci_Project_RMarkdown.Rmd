---
title: "Advanced Data Science I Project: Hurricane Harvey Severity by Tweets"
author: "Ben Barrett"
...
packages<-c("tibble","dplyr", "tidyr", "stringr", "jsonlite", "rdrop2", "data.table", "ggplot2", "maps", "ggmap", "gridExtra", "grid", "spatstat", "splancs", "maptools", "rgeos")
...
Spatial statistical analyses were performed with the assistance of the R packages maps (18), spatstat (19), splancs (20), maptools (21), and rgeos (22). 
...
mtext("Figure 3: Estimated K-function for Hurricane Harvey tweets, comparing the observed clustering of \ntweets (black) to the clustering that would be expected under complete spatial randomness (CSR; blue).", side=1, line=4, cex=0.75)
...
mtext("Figure 4: Observed clustering of Hurricane Harvey tweets (black), as compared to the number of \ntweets as would be expected under complete spatial randomness (CSR; blue).", side=1, line=4, cex=0.75)
