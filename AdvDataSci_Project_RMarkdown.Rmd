...
packages<-c("tibble","dplyr", "tidyr", "stringr", "jsonlite", "rdrop2", "data.table", "ggplot2", "maps", "ggmap", "gridExtra", "grid", "spatstat", "splancs", "maptools", "rgeos", "repmis", "RCurl")
...
# Saving the data file to be used for analysis. Processing above had to be done in order to allow for the datafile to be saved as a CSV
...
all_locations <- read.csv(text=getURL("https://raw.github.com/Ben4444/AdvDataSci_Project/blob/master/all_locations.csv"))
